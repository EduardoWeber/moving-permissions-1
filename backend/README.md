...
## Project Structure
    ...
    ├── moving_permissions_1  # Django project configurations
...
1. Clone this repo and `cd moving_permissions_1`
...
2. Clone this repo and `cd moving_permissions_1`
